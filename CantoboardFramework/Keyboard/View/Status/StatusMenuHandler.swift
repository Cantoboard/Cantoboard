...
extension StatusMenuHandler where Self: BaseKeyboardView {
    ...
    func showStatusMenu() {
        ...
        let menuRows: [[KeyCap]] = state.keyboardIdiom == .phone && layoutConstants.ref.isPortrait ? [
            ...
            [ .changeSchema(.cangjie), .changeSchema(.quick), .changeSchema(.ciping) ],
            ...
            [ .changeSchema(.cangjie), .changeSchema(.quick), .changeSchema(.ciping), .changeSchema(.stroke), .changeSchema(.mandarin) ],
        ]
