...
class LocalizedStrings {
    ...
    static let smartSymbolShapeDefault = localizedString("inputMethodSettings.smartSymbolShapeDefault")
    static let smartSymbolShapeDefault_half = localizedString("inputMethodSettings.smartSymbolShapeDefault.half")
